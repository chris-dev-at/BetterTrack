...
| Issue                               | Risk                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| ----------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **PAR1 #1122**                      | The paranoid-enable wizard rate-limits itself. The `docs/paranoid-design.md` §7 capture fires ~46 requests in one 10s window against a 60 req/10s burst limit on a _tiny_ account, and scales with portfolios × tax years — so a realistic account **fails its first enable attempt on a one-way destructive transition**, sees a generic "you're doing that too fast" banner, and each retry is punished harder by the escalation ladder. |
...
and SHR1 are the exception because they are _unfinished_ rather than _unfound_: each is the
remaining half of a bug whose other half already shipped — VLT1 the `GET` left open after
SEC2 closed the `PUT`, SHR1 the server left open after UXB5 fixed the client. A
half-closed hole is precisely the state you do not want to sign off in.

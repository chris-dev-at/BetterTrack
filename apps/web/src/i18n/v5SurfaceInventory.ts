 ...
 *
 * 185 → 199 with paranoid E8: the shell directory/chip (2), fail-closed
 ...
 * delegates them to the exact row that owns the retry action. The +14 is
 * disjoint from E5's ConnectionsPanel read above, which E8 does not touch.
 */
export const V5_ASYNC_READ_SITE_BASELINE = 199;

...
/**
 * Independent plain/shared-domain oracle for the encrypted TEST VECTOR. Both
 * the legacy and split-document engines compare against this exact result, so
 * client-to-client agreement cannot hide a shared adapter regression.
 */
export async function expectedClientMoneyFixtureDerivation() {

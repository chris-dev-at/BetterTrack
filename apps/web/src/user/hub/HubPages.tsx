...
const CONTROL_GROUPS: readonly ControlGroup[] = [
  {
    ...
    entries: [
      { to: '/settings/account', icon: 'user', labelKey: 'control.account', subKey: 'control.accountSub' },
      { to: '/settings/notifications', icon: 'bell', labelKey: 'control.notifications', subKey: 'control.notificationsSub' },
      { to: '/settings/security', icon: 'shield', labelKey: 'control.security', subKey: 'control.securitySub' },
      { to: '/settings/taxes', icon: 'percent', labelKey: 'control.taxes', subKey: 'control.taxesSub' },
    ],
  },
  {
    titleKey: 'control.groups.data',
    entries: [
      { to: '/settings/connections', icon: 'link', labelKey: 'control.connections', subKey: 'control.connectionsSub' },
      { to: '/settings/imports', icon: 'upload', labelKey: 'control.imports', subKey: 'control.importsSub' },
      { to: '/settings/backups', icon: 'cloud', labelKey: 'control.backups', subKey: 'control.backupsSub' },
      { to: '/control/privacy', icon: 'lock', labelKey: 'control.privacy', subKey: 'control.privacySub' },
      { to: '/control/data', icon: 'database', labelKey: 'control.dataManagement', subKey: 'control.dataManagementSub', parked: true },
    ],
  },
  {
    titleKey: 'control.groups.developer',
    entries: [
      { to: '/developer', icon: 'code', labelKey: 'control.developer', subKey: 'control.developerSub' },
      { to: '/settings/api', icon: 'key', labelKey: 'control.apiKeys', subKey: 'control.apiKeysSub' },
      { to: '/developer/webhooks', icon: 'webhook', labelKey: 'control.webhooks', subKey: 'control.webhooksSub' },
      { to: '/developer/mcp', icon: 'terminal', labelKey: 'control.mcp', subKey: 'control.mcpSub', parked: true },
      { to: '/developer/logs', icon: 'document', labelKey: 'control.logs', subKey: 'control.logsSub', parked: true },
    ],
  },
];

-- V5-P13 PD6 review follow-up — inactive, expiring server-medium candidates.
-- A candidate is never the live server DataHome: a verified media PATCH moves
-- it into paranoid_vaults atomically with activating the server medium.

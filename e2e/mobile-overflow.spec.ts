 ...
 * standard phone sheets, a data-backed chat sheet, an asset menu, and a nested
 * Control Center confirmation all get opened and measured in both profiles.
 */
    ...
    return elements.flatMap((candidate) => {
      ...
      const childScrollers = [
        ...element.querySelectorAll<HTMLElement>(
          '.bt-cc__content, .bt-dialog__body, .bt-palette__body',
        ),
      ].filter(visible);
      return [
        measure(element),
